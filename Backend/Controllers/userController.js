...
module.exports.forgot = ( req, res, next)=> { 
    ...
    if (users.length <=0) { 
        ...
        const mailOptions = {
            ...
            html: '<p><b> Your login details for Halal Restaurant </b><br><b>Email: </b> '+ users[0].email+'<br> <b>password: </b>'+users[0].password+'<br><a href= "http://localhost:4200">Click here to login</a>'+'</p>'
          };
